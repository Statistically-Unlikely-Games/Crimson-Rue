...
init python:
    ...
    def showCurrentDays(direction, imgSize, posX, posY, displayFullName, startDelay=0):
        ...
        for i in xrange(-2, 6):
            ...
            if startDelay > 0:
                #add if statement here to change dayButton to moon_img? Call moon_check?
