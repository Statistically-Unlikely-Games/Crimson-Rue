...
#Books
    ...
    $ herbID2 = Item("Herb Identification vol. 2", "A book of herbs", "inv/book.png", 5000, act=[enc_code.actions.UnlockEncEntry(en2),Show("inventory_popup", message="New Herbs Unlocked"), SetVariable('time_cnt',time_cnt+1), Function(renpy.call, "time_img")])
    $ herbID3 = Item("Herb Identification vol. 3", "A book of herbs", "inv/book.png", 5000, act=[enc_code.actions.UnlockEncEntry(en3),Show("inventory_popup", message="New Herbs Unlocked"), SetVariable('time_cnt',time_cnt+1), Function(renpy.call, "time_img")])
...
#Tier 2 Items
    ...
    $ extract002 = Item("Dandelion Extract", "Made by boiling herbs.", "inv/bottle.extract.png", 550, recipe=[[water,1],[herb002,1]])
    $ extract003 = Item("Blackberry Extract", "Made by boiling herbs.", "inv/bottle.extract.png", 550, recipe=[[water,1],[herb003,1]])
    $ extract004 = Item("Oak Extract", "Made by boiling herbs.", "inv/bottle.extract.png", 550, recipe=[[water,1],[herb004,1]])
    $ extract005 = Item("Garlic Extract", "Made by boiling herbs.", "inv/bottle.extract.png", 550, recipe=[[water,1],[herb005,1]])
    $ extract006 = Item("Mint Extract", "Made by boiling herbs.", "inv/bottle.extract.png", 550, recipe=[[water,1],[herb006,1]])
    $ extract007 = Item("Oregano Extract", "Made by boiling herbs.", "inv/bottle.extract.png", 550, recipe=[[water,1],[herb007,1]])
    $ extract008 = Item("Parsley Extract", "Made by boiling herbs.", "inv/bottle.extract.png", 550, recipe=[[water,1],[herb008,1]])
    $ extract009 = Item("Sage Extract", "Made by boiling herbs.", "inv/bottle.extract.png", 550, recipe=[[water,1],[herb009,1]])
    $ extract010 = Item("Laurel Extract", "Made by boiling herbs.", "inv/bottle.extract.png", 550, recipe=[[water,1],[herb010,1]])
    $ extract011 = Item("Hyssop Extract", "Made by boiling herbs.", "inv/bottle.extract.png", 550, recipe=[[water,1],[herb011,1]])
    ...
    $ herb_oil003 = Item("Blackberry Oil", "Made by soaking herbs in oil.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb003,1]]) 
    $ herb_oil004 = Item("Oak Oil", "Made by soaking herbs in oil.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb004,1]]) 
    $ herb_oil005 = Item("Garlic Oil", "Made by soaking herbs in oil.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb005,1]]) 
    $ herb_oil006 = Item("Mint Oil", "Made by soaking herbs in oil.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb006,1]]) 
    $ herb_oil007 = Item("Oregano Oil", "Made by soaking herbs in oil.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb007,1]]) 
    $ herb_oil008 = Item("Parsley Oil", "Made by soaking herbs in oil.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb008,1]]) 
    $ herb_oil009 = Item("Sage Oil", "Made by soaking herbs in oil.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb009,1]]) 
    $ herb_oil010 = Item("Laurel Oil", "Made by soaking herbs in oil.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb010,1]]) 
    $ herb_oil011 = Item("Hyssop Oil", "Made by soaking herbs in oil.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb011,1]]) 
 ...
 #Tier 3 Items
    ...
    $ balm002 = Item("Dandelion Balm", "Medicine applied to the skin.", "inv/tin.medicine05.png", 1400, recipe=[[wax,1],[herb_oil002,1]])
    $ balm003 = Item("Blackberry Balm", "Medicine applied to the skin.", "inv/tin.medicine05.png", 1400, recipe=[[wax,1],[herb_oil003,1]])
    $ balm004 = Item("Oak Balm", "Medicine applied to the skin.", "inv/tin.medicine05.png", 1400, recipe=[[wax,1],[herb_oil004,1]])
    $ balm005 = Item("Garlic Balm", "Medicine applied to the skin.", "inv/tin.medicine05.png", 1400, recipe=[[wax,1],[herb_oil005,1]])
    $ balm006 = Item("Mint Balm", "Medicine applied to the skin.", "inv/tin.medicine05.png", 1400, recipe=[[wax,1],[herb_oil006,1]])
    $ balm007 = Item("Oregano Balm", "Medicine applied to the skin.", "inv/tin.medicine05.png", 1400, recipe=[[wax,1],[herb_oil007,1]])
    $ balm008 = Item("Parsley Balm", "Medicine applied to the skin.", "inv/tin.medicine05.png", 1400, recipe=[[wax,1],[herb_oil008,1]])
    $ balm009 = Item("Sage Balm", "Medicine applied to the skin.", "inv/tin.medicine05.png", 1400, recipe=[[wax,1],[herb_oil009,1]])
    $ balm010 = Item("Laurel Balm", "Medicine applied to the skin.", "inv/tin.medicine05.png", 1400, recipe=[[wax,1],[herb_oil010,1]])
    $ balm011 = Item("Hyssop Balm", "Medicine applied to the skin.", "inv/tin.medicine05.png", 1400, recipe=[[wax,1],[herb_oil011,1]])
    ...
    $ cream003 = Item("Blackberry Cream", "Medicine applied to the skin.", "inv/jar.medicine04.png", 2400, recipe=[[empty_jar,1],[water,2],[wax,1],[herb_oil003,1]])
    $ cream004 = Item("Oak Cream", "Medicine applied to the skin.", "inv/jar.medicine04.png", 2400, recipe=[[empty_jar,1],[water,2],[wax,1],[herb_oil004,1]])
    $ cream005 = Item("Garlic Cream", "Medicine applied to the skin.", "inv/jar.medicine04.png", 2400, recipe=[[empty_jar,1],[water,2],[wax,1],[herb_oil005,1]])
    $ cream006 = Item("Mint Cream", "Medicine applied to the skin.", "inv/jar.medicine04.png", 2400, recipe=[[empty_jar,1],[water,2],[wax,1],[herb_oil006,1]])
    $ cream007 = Item("Oregano Cream", "Medicine applied to the skin.", "inv/jar.medicine04.png", 2400, recipe=[[empty_jar,1],[water,2],[wax,1],[herb_oil007,1]])
    $ cream008 = Item("Parsley Cream", "Medicine applied to the skin.", "inv/jar.medicine04.png", 2400, recipe=[[empty_jar,1],[water,2],[wax,1],[herb_oil008,1]])
    $ cream009 = Item("Sage Cream", "Medicine applied to the skin.", "inv/jar.medicine04.png", 2400, recipe=[[empty_jar,1],[water,2],[wax,1],[herb_oil009,1]])
    $ cream010 = Item("Laurel Cream", "Medicine applied to the skin.", "inv/jar.medicine04.png", 2400, recipe=[[empty_jar,1],[water,2],[wax,1],[herb_oil010,1]])
    $ cream011 = Item("Hyssop Cream", "Medicine applied to the skin.", "inv/jar.medicine04.png", 2400, recipe=[[empty_jar,1],[water,2],[wax,1],[herb_oil011,1]])
    ...
    $ infusion004 = Item("Oak Infusion", "Medicine you can drink.", "inv/bottle.medicine01.png", 1200, recipe=[[water,1],[extract004,1]])
    $ infusion005 = Item("Garlic Infusion", "Medicine you can drink.", "inv/bottle.medicine01.png", 1200, recipe=[[water,1],[extract005,1]])
    $ infusion006 = Item("Mint Infusion", "Medicine you can drink.", "inv/bottle.medicine01.png", 1200, recipe=[[water,1],[extract006,1]])
    $ infusion007 = Item("Oregano Infusion", "Medicine you can drink.", "inv/bottle.medicine01.png", 1200, recipe=[[water,1],[extract007,1]])
    $ infusion008 = Item("Parsley Infusion", "Medicine you can drink.", "inv/bottle.medicine01.png", 1200, recipe=[[water,1],[extract008,1]])
    $ infusion009 = Item("Sage Infusion", "Medicine you can drink.", "inv/bottle.medicine01.png", 1200, recipe=[[water,1],[extract009,1]])
    $ infusion010 = Item("Laurel Infusion", "Medicine you can drink.", "inv/bottle.medicine01.png", 1200, recipe=[[water,1],[extract010,1]])
    $ infusion011 = Item("Hyssop Infusion", "Medicine you can drink.", "inv/bottle.medicine01.png", 1200, recipe=[[water,1],[extract011,1]])
    ...
    $ salve004 = Item("Oak Salve", "Medicine applied to the skin.", "inv/jar.medicine03.png", 3000, recipe=[[empty_jar,1],[oil,2],[wax,1],[herb_oil004,1]])
    $ salve005 = Item("Garlic Salve", "Medicine applied to the skin.", "inv/jar.medicine03.png", 3000, recipe=[[empty_jar,1],[oil,2],[wax,1],[herb_oil005,1]])
    $ salve006 = Item("Mint Salve", "Medicine applied to the skin.", "inv/jar.medicine03.png", 3000, recipe=[[empty_jar,1],[oil,2],[wax,1],[herb_oil006,1]])
    $ salve007 = Item("Oregano Salve", "Medicine applied to the skin.", "inv/jar.medicine03.png", 3000, recipe=[[empty_jar,1],[oil,2],[wax,1],[herb_oil007,1]])
    $ salve008 = Item("Parsley Salve", "Medicine applied to the skin.", "inv/jar.medicine03.png", 3000, recipe=[[empty_jar,1],[oil,2],[wax,1],[herb_oil008,1]])
    $ salve009 = Item("Sage Salve", "Medicine applied to the skin.", "inv/jar.medicine03.png", 3000, recipe=[[empty_jar,1],[oil,2],[wax,1],[herb_oil009,1]])
    $ salve010 = Item("Laurel Salve", "Medicine applied to the skin.", "inv/jar.medicine03.png", 3000, recipe=[[empty_jar,1],[oil,2],[wax,1],[herb_oil010,1]])
    $ salve011 = Item("Hyssop Salve", "Medicine applied to the skin.", "inv/jar.medicine03.png", 3000, recipe=[[empty_jar,1],[oil,2],[wax,1],[herb_oil011,1]])
    ...
    $ tincture003 = Item("Blackberry Tincture", "Medicine you can drink.", "inv/bottle.medicine02.png", 1500, recipe=[[wine,1],[extract003,1]]) 
    $ tincture004 = Item("Oak Tincture", "Medicine you can drink.", "inv/bottle.medicine02.png", 1500, recipe=[[wine,1],[extract004,1]]) 
    $ tincture005 = Item("Garlic Tincture", "Medicine you can drink.", "inv/bottle.medicine02.png", 1500, recipe=[[wine,1],[extract005,1]]) 
    $ tincture006 = Item("Mint Tincture", "Medicine you can drink.", "inv/bottle.medicine02.png", 1500, recipe=[[wine,1],[extract006,1]]) 
    $ tincture007 = Item("Oregano Tincture", "Medicine you can drink.", "inv/bottle.medicine02.png", 1500, recipe=[[wine,1],[extract007,1]]) 
    $ tincture008 = Item("Parsley Tincture", "Medicine you can drink.", "inv/bottle.medicine02.png", 1500, recipe=[[wine,1],[extract008,1]]) 
    $ tincture009 = Item("Sage Tincture", "Medicine you can drink.", "inv/bottle.medicine02.png", 1500, recipe=[[wine,1],[extract009,1]]) 
    $ tincture010 = Item("Laurel Tincture", "Medicine you can drink.", "inv/bottle.medicine02.png", 1500, recipe=[[wine,1],[extract010,1]]) 
    $ tincture011 = Item("Hyssop Tincture", "Medicine you can drink.", "inv/bottle.medicine02.png", 1500, recipe=[[wine,1],[extract011,1]]) 
