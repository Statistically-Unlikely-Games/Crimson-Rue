...
#    $ coin = Item("Coin", "An old coin", "inv/coin.png", 1, act=Show("inventory_popup", message="This item is only used in crafting"))
    ...
    $ herb011 = Item("Herb 11", "A medicinal herb.", "inv/herb011_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb012 = Item("Herb 12", "A medicinal herb.", "inv/herb012_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb013 = Item("Herb 13", "A medicinal herb.", "inv/herb013_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb014 = Item("Herb 14", "A medicinal herb.", "inv/herb014_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb015 = Item("Herb 15", "A medicinal herb.", "inv/herb015_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb016 = Item("Herb 16", "A medicinal herb.", "inv/herb016_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb017 = Item("Herb 17", "A medicinal herb.", "inv/herb017_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb018 = Item("Herb 18", "A medicinal herb.", "inv/herb018_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb019 = Item("Herb 19", "A medicinal herb.", "inv/herb019_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb020 = Item("Herb 20", "A medicinal herb.", "inv/herb020_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
