...
#Tier 1 Items
    ...
    $ herb001 = Item("Thistle", "A medicinal herb. Seeds are best collected when the flowers have dried out, generally starting in early fall.", "inv/herb001_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb002 = Item("Dandelion", "A medicinal herb. Roots are best harvested in late fall to early spring. Collect from large, vigorous plants.", "inv/herb002_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    ...
    $ herb026 = Item("Burdock", "A plant whose seeds and roots have medicinal properties. Rarely, the leaves are also used. Can be processed to treat various skin conditions and to promote liver function.", "inv/herb026_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb027 = Item("Comfrey", "A plant whose leaves and roots have medicinal properties. The roots are more potent, but the leaves are more palatable. Can be processed to treat inflammation and promote healing.", "inv/herb027_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb028 = Item("Goldenseal", "A plant whose bright yellow roots have medicinal properties. Best harvested in the fall, choosing older plants whose leaves have started to die off. Act as a strong anti-bacterial and can be processed to treat indigestion.", "inv/herb028_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb029 = Item("Lemon Balm", "A plant whose leaves and flowers have medicinal properties. Can be processed to treat stress and anxiety, irritated stomaches, and mild insomnia. Has a strong lemony aroma.", "inv/herb029_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
    $ herb030 = Item("Licorice", "A plant whose roots have medicinal properties. Can be processed to treat fatigue and respiratory inflammation.", "inv/herb030_idle.png", 100, act=Show("inventory_popup", message="This item is only used in crafting"))
...
#Tier 2 Items
    ...
    $ dried_herb027 = Item("Dried Comfrey", "A dried medicinal herb. Can be infused to make tinctures or tea, as well as processed into a powder.", "inv/herb027_idle.png", 200, recipe=[[herb027,1]], containers=[])
    $ dried_herb028 = Item("Dried Goldenseal", "Dried goldenseal root. Can be infused to make tinctures or tea, as well as processed into a powder.", "inv/herb028_idle.png", 200, recipe=[[herb028,1]], containers=[])
#    $ dried_herb029 = Item("Dried Lemon Balm", "A dried medicinal herb.", "inv/herb029_idle.png", 200, recipe=[[herb029,1]], containers=[])
    $ dried_herb030 = Item("Dried Licorice", "Dried licorice root. Can be infused to make tea or processed into a powder.", "inv/herb030_idle.png", 200, recipe=[[herb030,1]], containers=[]) #Generally baked to dry
    ...
    $ herb_oil026 = Item("Burdock Oil", "Made by soaking burdock leaves or seeds in oil.Can be processed into medicine.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb026,1]], containers=[])
    $ herb_oil027 = Item("Comfrey Oil", "Made by soaking comfrey leaves in oil. Can be processed into medicine.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb027,1]], containers=[])
    $ herb_oil028 = Item("Goldenseal Oil", "Made by soaking goldenseal root in oil. Can be processed into medicine.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb028,1]], containers=[])
    $ herb_oil029 = Item("Lemon Balm Oil", "Made by soaking lemon balm leaves in oil. May be added to edible dishes for flavor or processed into medicine.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb029,1]], containers=[])
#    $ herb_oil030 = Item("Licorice Oil", "Made by soaking herbs in oil.", "inv/bottle.extract.png", 800, recipe=[[oil,1],[herb030,1]], containers=[])
    ...
    $ tincture028 = Item("Goldenseal Tincture", "A strong medicine made by soaking goldenseal root in alcohol. Often diluted and used as a mouth or eye wash to treat infections.", "inv/bottle.medicine02.png", 1500, recipe=[[vodka,1],[herb028,1]], containers=[[empty_bottle,1]])
    $ tincture029 = Item("Lemon Balm Tincture", "A strong medicine made by soaking lemon balm in alcohol. Commonly used to treat irritated stomachs and mild insomnia.", "inv/bottle.medicine02.png", 1500, recipe=[[vodka,1],[herb029,1]], containers=[[empty_bottle,1]])
...
#    $ balm010 = Item("Laurel Balm", "Medicine applied to the skin.", "inv/tin.medicine05.png", 1400, recipe=[[wax,1],[herb_oil010,1]], containers=[[empty_bottle,1]])
    ...
    $ cream029 = Item("Lemon Balm Cream", "Medicine made from lemon balm, it is applied externally. Often used to soothe herpes sores.", "inv/jar.medicine04.png", 2400, recipe=[[empty_jar,1],[water,2],[wax,1],[herb_oil029,1]], containers=[[empty_bottle,3], [empty_tin,1]])
...
#    $ essential_oil001
    ...
    $ infusion027 = Item("Comfrey Infusion", "A medicinal tea made by boiling comfrey leaves. Helps calm inflammation and promote healing.", "inv/bottle.medicine01.png", 550, recipe=[[water,1],[dried_herb027,1]], containers=[])
    $ infusion028 = Item("Goldenseal Infusion", "A medicinal tea made by boiling goldenseal root. Used as a digestive aid. Has a strong, bitter flavor.", "inv/bottle.medicine01.png", 550, recipe=[[water,1],[herb028,1]], containers=[])
    $ infusion029 = Item("Lemon Balm Infusion", "A medicinal tea made by boiling the leaves, and sometimes flowers, of the lemon balm plant. Helps alleviate stress and anxiety. True to its name, has a distinct lemony flavor.", "inv/bottle.medicine01.png", 550, recipe=[[water,1],[herb029,1]], containers=[])
    $ infusion030 = Item("Licorice Infusion", "A medicinal tea made by boiling licorice root. Used to treat fatigue. Has a very sweet flavor.", "inv/bottle.medicine01.png", 550, recipe=[[water,1],[dried_herb030,1]], containers=[])
    ...
    $ powdered_herb028 = Item("Powdered Goldenseal", "Powdered goldenseal root. Often used in conjunction with other herbs due to its strong antibiotic properties.", "inv/powder.medium.png", 300, recipe=[[empty_bottle,1],[dried_herb028,1]], containers=[])
#    $ powdered_herb029 = Item("Powdered Lemon Balm", "A powdered medicinal herb.", "inv/herb029_idle.png", 300, recipe=[[empty_bottle,1],[dried_herb029,1]], containers=[])
    $ powdered_herb030 = Item("Powdered Licorice", "Powdered licorice root. Often added to pills in order to offest bad-tasting herbs.", "inv/powder.coarse.png", 300, recipe=[[empty_bottle,1],[dried_herb030,1]], containers=[])
    
    $ mixed_powder_liver = Item("Liver Powder Mix", "Powdered thistle seeds, dandelion root, and burdock root. Generally processed into pills.", "inv/powder.coarse.png", 300, recipe=[[empty_bottle,1],[dried_herb001,1],[dried_herb002,1],[dried_herb026,1]], containers=[])
...
#    $ bath_blend001
    ...
    $ decoction026 = Item("Burdock Decoction", "Very concentrated liquid medicine made from burdock root.", "inv/bottle.extract.png", 2000, recipe=[[infusion026,1]], containers=[])
    $ decoction027 = Item("Comfrey Decoction", "Very concentrated liquid medicine made from comfrey root. It calms inflammation and promotes healing.", "inv/bottle.extract.png", 2000, recipe=[[infusion027,1]], containers=[])
    $ decoction028 = Item("Goldenseal Decoction", "Very concentrated liquid medicine made from the root of the goldenseal plant. Used to treat indigestion. Very bitter.", "inv/bottle.extract.png", 2000, recipe=[[infusion028,1]], containers=[])
#    $ decoction029 = Item("Lemon Balm Decoction", "Very concentrated liquid medicine.", "inv/bottle.extract.png", 2000, recipe=[[infusion029,1]], containers=[])
    $ decoction030 = Item("Licorice Decoction", "Very concentrated liquid medicine made from the root of the licorice plant. Often processed into a syrup to soothe sore throats and treat respiratory inflammation. It is extremely sweet, and thus usually used with other herbs.", "inv/bottle.extract.png", 2000, recipe=[[infusion030,1]], containers=[])
    
#    $ compress001
    
#    $ perfume001
    
    $ pill001 = Item("Liver Pills", "Oral medicine taken to promote liver function.", "inv/jar.medicine03.png", 2000, recipe=[[water,1],[honey,1],[mixed_powder_liver,1]], containers=[[empty_bottle,1]])
