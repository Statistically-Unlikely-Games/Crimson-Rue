...
#    $ essential_oil001
    ...
    $ powdered_herb001 = Item("Powdered Thistle", "A powdered medicinal herb.", "inv/herb001_idle.png", 300, recipe=[[empty_bottle,1],[herb001,1]], containers=[])
    $ powdered_herb002 = Item("Powdered Dandelion", "A powdered medicinal herb.", "inv/herb002_idle.png", 300, recipe=[[empty_bottle,1],[herb002,1]], containers=[])
    $ powdered_herb003 = Item("Powdered Blackberry", "A powdered medicinal herb.", "inv/herb003_idle.png", 300, recipe=[[empty_bottle,1],[herb003,1]], containers=[])
    $ powdered_herb004 = Item("Powdered Oak", "A powdered medicinal herb.", "inv/herb004_idle.png", 300, recipe=[[empty_bottle,1],[herb004,1]], containers=[])
    $ powdered_herb005 = Item("Powdered Garlic", "A powdered medicinal herb.", "inv/herb005_idle.png", 300, recipe=[[empty_bottle,1],[herb005,1]], containers=[])
    $ powdered_herb006 = Item("Powdered Mint", "A powdered medicinal herb.", "inv/herb006_idle.png", 300, recipe=[[empty_bottle,1],[herb006,1]], containers=[])
    $ powdered_herb007 = Item("Powdered Oregano", "A powdered medicinal herb.", "inv/herb007_idle.png", 300, recipe=[[empty_bottle,1],[herb007,1]], containers=[])
    $ powdered_herb008 = Item("Powdered Parsley", "A powdered medicinal herb.", "inv/herb008_idle.png", 300, recipe=[[empty_bottle,1],[herb008,1]], containers=[])
    $ powdered_herb009 = Item("Powdered Sage", "A powdered medicinal herb.", "inv/herb009_idle.png", 300, recipe=[[empty_bottle,1],[herb009,1]], containers=[])
    $ powdered_herb010 = Item("Powdered Laurel", "A powdered medicinal herb.", "inv/herb010_idle.png", 300, recipe=[[empty_bottle,1],[herb010,1]], containers=[])
    $ powdered_herb011 = Item("Powdered Hyssop", "A powdered medicinal herb.", "inv/herb011_idle.png", 300, recipe=[[empty_bottle,1],[herb011,1]], containers=[])
    $ powdered_herb012 = Item("Powdered Borage", "A powdered medicinal herb.", "inv/herb012_idle.png", 300, recipe=[[empty_bottle,1],[herb012,1]], containers=[])
    $ powdered_herb013 = Item("Powdered Crown Flower", "A powdered medicinal herb.", "inv/herb013_idle.png", 300, recipe=[[empty_bottle,1],[herb013,1]], containers=[])
    $ powdered_herb014 = Item("Powdered Marsh Marigold", "A powdered medicinal herb.", "inv/herb014_idle.png", 300, recipe=[[empty_bottle,1],[herb014,1]], containers=[])
    $ powdered_herb015 = Item("Powdered Plantain", "A powdered medicinal herb.", "inv/herb015_idle.png", 300, recipe=[[empty_bottle,1],[herb015,1]], containers=[])
    $ powdered_herb016 = Item("Powdered Chamomile", "A powdered medicinal herb.", "inv/herb016_idle.png", 300, recipe=[[empty_bottle,1],[herb016,1]], containers=[])
    $ powdered_herb017 = Item("Powdered Calendula", "A powdered medicinal herb.", "inv/herb017_idle.png", 300, recipe=[[empty_bottle,1],[herb017,1]], containers=[])
    $ powdered_herb018 = Item("Powdered Violet", "A powdered medicinal herb.", "inv/herb018_idle.png", 300, recipe=[[empty_bottle,1],[herb018,1]], containers=[])
    $ powdered_herb019 = Item("Powdered Rosemary", "A powdered medicinal herb.", "inv/herb019_idle.png", 300, recipe=[[empty_bottle,1],[herb019,1]], containers=[])
    $ powdered_herb020 = Item("Powdered Basil", "A powdered medicinal herb.", "inv/herb020_idle.png", 300, recipe=[[empty_bottle,1],[herb020,1]], containers=[])
    $ powdered_herb021 = Item("Powdered Poppy", "A powdered medicinal herb.", "inv/herb021_idle.png", 300, recipe=[[empty_bottle,1],[herb021,1]], containers=[])
    $ powdered_herb022 = Item("Powdered Mullein", "A powdered medicinal herb.", "inv/herb022_idle.png", 300, recipe=[[empty_bottle,1],[herb022,1]], containers=[])
    $ powdered_herb023 = Item("Powdered Red Clover", "A powdered medicinal herb.", "inv/herb023_idle.png", 300, recipe=[[empty_bottle,1],[herb023,1]], containers=[])
    $ powdered_herb024 = Item("Powdered St. John's Wort", "A powdered medicinal herb.", "inv/herb024_idle.png", 300, recipe=[[empty_bottle,1],[herb024,1]], containers=[])
    $ powdered_herb025 = Item("Powdered Yellow Dock", "A powdered medicinal herb.", "inv/herb025_idle.png", 300, recipe=[[empty_bottle,1],[herb025,1]], containers=[])
    $ powdered_herb026 = Item("Powdered Burdock", "A powdered medicinal herb.", "inv/herb026_idle.png", 300, recipe=[[empty_bottle,1],[herb026,1]], containers=[])
    $ powdered_herb027 = Item("Powdered Comfrey", "A powdered medicinal herb.", "inv/herb027_idle.png", 300, recipe=[[empty_bottle,1],[herb027,1]], containers=[])
    $ powdered_herb028 = Item("Powdered Goldenseal", "A powdered medicinal herb.", "inv/herb028_idle.png", 300, recipe=[[empty_bottle,1],[herb028,1]], containers=[])
    $ powdered_herb029 = Item("Powdered Lemon Balm", "A powdered medicinal herb.", "inv/herb029_idle.png", 300, recipe=[[empty_bottle,1],[herb029,1]], containers=[])
    $ powdered_herb030 = Item("Powdered Licorice", "A powdered medicinal herb.", "inv/herb030_idle.png", 300, recipe=[[empty_bottle,1],[herb030,1]], containers=[])
