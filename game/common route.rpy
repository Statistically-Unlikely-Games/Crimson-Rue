...
#    "This is a dialogue test."
    ...
    n "The air is cold, carrying the strong smell of pine, which I've always associated with home."
    ...
    n "I step out into the crisp snow, removing my hood to get a better look."
    
    n "It has been so long since I last saw this familiar landscape, smelled this familiar forest."
    
    aeth_int "(I'm glad we were able to make it before the roads snowed in.)"
    
    n "A member of the caravan I have been traveling with jogs up to me."
    ...
    n "The trader smiles at me, but it seems somewhat strained."
    ...
    n "That isn't possible, but I appreciate the gesture. I have been worried the caravan members resented me."
    ...
    n "I make my rounds one last time, checking in on a few sick and injured travelers and saying a short farewell."
...
## leaving the caravan with baggage, but don't want to hit them repeatedly over the head with it.
    ...
    n "The sun is barely creeping out from behind the horizon when I reach my mother's house."
    
    n "I heave open the heavy oak door and announce myself."
    ...
    n "The room is dimly lit, and I hear a shuffling sound coming from the back."
    
    n "My mother scrambles forward, looking disheveled."
    
    show kayen neu at easein_rightctr
    
    kayen "Aeth-- What are you doing back this time of year?"
    
    n "I think I see the shadow of another person back there..."
    ...
    n "I dump my bag onto the floor and start preparing for dinner."
    
    scene bg black
    with slow_dissolve
    
    n "I lay down as sleep takes me, exhausted from my long journey."
    
    scene bg forest002
    with slow_dissolve
    
    n "The next day, I decide to head into town."
    
    show aeth neu at left
    with moveinleft
    
    n "As I approach my master's shop, I see a small child hiding around the corner."
    ...
    n "The child seems surprised to hear a voice behind them and jumps slightly. I stare blankly at them, waiting for a response."
    
    n "Instead of responding, they back away slowly and then run around a corner."
    
    hide lufte
    
    n "I stare after them for a moment, considering if I need to go after them. But it doesn't look like they were hurting anything, so I go about my business."
    
    scene bg apothecary
    with slow_dissolve
    
    n "When I enter the shop, Master Elaine is busily preparing the morning's medication."
    ...
    n "She hurriedly shoves an assortment of bottles and tools on the counter, and pushes them in my direction."
    ...
    n "Faster than I can register, the morning is over. Elaine sent me out to pick up supplies and deliver medications in town."
    
    n "I started with deliveries, figuring that I'd then only have to carry supplies on the way home."
    
    n "I approach a small house on the outskirts of town."
    
    show aeth neu at left
    
    aeth "Hm, this seems to be the right place."
    
    n "Supposedly a young man lives here named Orthrus, and I am supposed to deliver medication for his younger sister."
    
    n "As I approached the door, a voice stops me."
    
    show orthrus neu right at left behind aeth
    
    orthrus_un "You have business with me?"
    
    n "He leans over me from behind, inches away from my ear. I did't hear him approach, and the sudden closeness causes me to instinctively tense up."
    ...
    n "He steps back, and I'm able to relax my muscles."
    
    orthrus "Ah, that'll be for me. Thanks for dropping them by, we'd just about run out."
    
    n "A wide grin spreads across his face as he reaches out and takes the bag."
    
    orthrus "You're Aeth, yeah? Kayen's kid? We met a few times when we were younger, dunno if you remember me?"
    
    n "I remember that Orthrus's family ran a merchant caravan, and he and his sister often traveled with them away from town."
    
    n "By the time they disappeared, I had already left on your journey, and because of this I haven't had much interaction with either sibling."
    
    n "It was possible we'd seen each other in passing, but I would have a hard time picking his face out of a crowd."
    
    n "I've learned that being so direct was considered rude by most, though, and remain silent unsure of what to say in response."
    ...
    n "I tip my head towards Orthrus in a greeting and reply"
    
    aeth "Thank you for your patronage."
    
    n "As I turned to leave, Orthrus waves me off cheekily."
    
    hide orthrus
    hide aeth
    
    n "That ended up being a bit more stressful than I'd anticipated, but I figure it worked out okay."
    
    n "The next stop on my agenda is the general store. I need to pick up some more glass bottles, as well as a few other essentials."
    
    scene bg itemshop
    with slow_dissolve
    
    n "I walk in and am greeted by the shopkeeper, Harte."
    
    show harte neu at right
    
    harte "Aeth! I heard you were back in town early. Elaine got you running errands already?"
    
    n "I give a small smile."
    ...
    n "Harte disappears into the back room for a moment, then comes out with a large, heavy box. She places it on the counter, then adds a few extra items from the supply shelf."
    ...
    n "I leave the shop and make my way toward the last errand."
    
    n "I take the main street through the center of town and end up in front of a shop with a sign that wasn't there last time I was here."
    
    n "It shows the Healer's crest, just like my master's shop. I step in and take a look around."
    
    scene bg apothecary
    with slow_dissolve
    
    n "The front of the shop has a more clinical feel than Master Elaine's-- it is missing the racks of dried herbs and general clutter."
    
    show mikael neu at center
    
    n "Instead, there are more seats, and a curtain near the back of the room. Not long after the door shut behind me a familiar figure steps out from behind the counter."
    ...
    n "His face emanates warmth, and I can't help but smile at the image of Master Elaine chasing the powerful guild members out of her shop."
    ...
    n "Mikael looks down and sees the fairly large and heavy box Aeth is carrying."
